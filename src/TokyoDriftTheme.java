...
public class TokyoDriftTheme {
    ...
    static Scene startSceneTokyo = new Scene(level1, Main.WIDTH, Main.HEIGHT);
    ...
    public static void generateTokyo(){
        ...
        startSceneTokyo = new Scene(rootTokyoStart, Main.WIDTH, Main.HEIGHT);
        Main.stage.setTitle("TokyoDrift Start");
        Main.stage.setScene(startSceneTokyo);
    ...
    public static void level1(){
        ...
        ImageView imageViewTorLevel1Tokyo = new ImageView(new Image("file:Tokyo/torInfinity1.png")); //add

       // Car carTEST = new Car(200, 300, new ImageView("file:Tokyo/car.png"));
        ...
        level1Root.getChildren().addAll(imageViewTorLevel1Tokyo, rectangle );

        Scene startSceneTokyo = new Scene(level1Root, Main.WIDTH, Main.HEIGHT);

        startSceneTokyo.setOnKeyPressed(event -> {
            if(event.getCode() == KeyCode.SPACE){
                Shooter.bullets(300,300,0,0);
            }
        });
